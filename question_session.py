...
questions = [
    # tells what job you do ?
    {
        "question": "1. Which of the following tasks is most central to your daily work?",
        "options": [
    ...
    {
        # tells primary focus
        "question": "In a project kickoff meeting, what would be your primary focus?",
        "options": [
    ...
    {
        # tells whether you assign the work to team or are getting assigned by others 
        "question": "Which tool do you use most frequently in your work?",
        "options": [
